...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>SIMANSE</b> SDN 83 PLG</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-edit"></i> <span>Regristrasi</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
           <li <?=$this->uri->segment(1) == 'regguru' ? 'class="active"' : ''?>>
             <a href="<?=base_url('regguru')?>"><i class="fa fa-circle-o"></i> Guru</a></li>>
             <li <?=$this->uri->segment(1) == 'regsiswa' ? 'class="active"' : ''?>>
             <a href="<?=base_url('regsiswa')?>"><i class="fa fa-circle-o"></i> Siswa</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li <?=$this->uri->segment(1) == 'gurupns' ? 'class="active"' : ''?>>
             <a href="<?=base_url('gurupns')?>"><i class="fa fa-circle-o"></i>Data Guru</a></li>
            <li <?=$this->uri->segment(1) == 'siswa' ? 'class="active"' : ''?>>
             <a href="<?=base_url('siswa')?>"><i class="fa fa-circle-o"></i>Data Siswa</a></li>
             <li <?=$this->uri->segment(1) == 'ruangan' ? 'class="active"' : ''?>>
             <a href="<?=base_url('ruangan')?>"><i class="fa fa-circle-o"></i>Data Ruangan</a></li>
          </ul>
        </li>
 ...
 <div class="content-wrapper">
   ...
   <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2020-2021 <a href="https://adminlte.io">Dellania Studio</a>.</strong> All rights
    reserved.
  </footer>
